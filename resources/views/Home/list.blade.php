    ...
    <div class="container">
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                ...
                <!-- Title -->
                <h1 class="mb-0 display-6">A TEAM MEDIC
                    <span class="position-relative">solution
                        <!-- SVG START -->
                ...
                <!-- Content -->
                <p class="my-4 lead">A Team Medic LLP  was form in 2008 by Captain Christopher Bek, PCGA, in Singapore. They had performed excellent service in Medical Evacuation, and provide hundreds of overseas trips to India, China, Philippines, Indonesia, Thailand, Vietnam Myanmar, Malaysja. He is well known in Asia as he had completed several hundreds of overseas Medical Evacuations, through recommendation all over the world.</p>
                
                <!-- Info -->
                <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                    <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>His office is at 865 Katong Shopping Centre and in Batam office at Batam Centre</li>
                    <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>Singapore No. +65 82280955</li>
                    <li class="list-inline-item"> <i class="bi bi-patch-check-fill h6 me-1"></i>Indonesia No. +62 82161921089 (whatsapp call only)</li>
                </ul>
