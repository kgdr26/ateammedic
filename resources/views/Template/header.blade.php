	...
	<nav class="navbar navbar-expand-xl">
		<div class="container-fluid px-3 px-xl-5">
			...
			<a class="navbar-brand" href="index.html">
				<img class="light-mode-item navbar-brand-item" src="{{asset('assets/image/logo_team.png')}}" alt="logo">
				<img class="dark-mode-item navbar-brand-item" src="{{asset('assets/image/logo_team.png')}}" alt="logo">
			</a>
			<!-- Logo END -->
