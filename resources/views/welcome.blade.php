...
<head>
	...
	<!-- Theme CSS -->
	<link rel="stylesheet" type="text/css" href="https://eduport.webestica.com/assets/css/style.css">
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container-fluid px-3 px-xl-5">
			...
			<a class="navbar-brand" href="index.html">
				<img class="light-mode-item navbar-brand-item" src="https://eduport.webestica.com/assets/images/logo.svg" alt="logo">
				<img class="dark-mode-item navbar-brand-item" src="https://eduport.webestica.com/assets/images/logo-light.svg" alt="logo">
			</a>
			<!-- Logo END -->
									...
									<div class="row p-4">
										...
										<div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
											...
											<div class="d-flex mb-4 position-relative">
												<img src="https://eduport.webestica.com/assets/images/client/uni-logo-01.svg" class="icon-md" alt="">
												<div class="ms-3">
											...
											<!-- Dropdown item -->
											<div class="d-flex mb-4 position-relative">
												<img src="https://eduport.webestica.com/assets/images/client/uni-logo-02.svg" class="icon-md" alt="">
												<div class="ms-3">
											...
											<!-- Dropdown item -->
											<div class="d-flex mb-4 position-relative">
												<img src="https://eduport.webestica.com/assets/images/client/uni-logo-03.svg" class="icon-md" alt="">
												<div class="ms-3">
											...
											<div class="d-flex position-relative">
												<img src="https://eduport.webestica.com/assets/images/client/uni-logo-04.svg" class="icon-md" alt="">
												<div class="ms-3">
					...
					<li class="px-3 mb-3">
						<div class="d-flex align-items-center">
							...
							<div class="avatar me-3">
								<img class="avatar-img rounded-circle shadow" src="https://eduport.webestica.com/assets/images/avatar/01.jpg" alt="avatar">
							</div>
							<div>
			...
			<div class="tab-pane fade" id="course-pills-tabs-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="https://eduport.webestica.com/assets/images/courses/4by3/05.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="https://eduport.webestica.com/assets/images/courses/4by3/06.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="https://eduport.webestica.com/assets/images/courses/4by3/10.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-info bg-opacity-10 text-info">Intermediate</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="https://eduport.webestica.com/assets/images/courses/4by3/13.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
			...
			<div class="tab-pane fade" id="course-pills-tabs-4" role="tabpanel" aria-labelledby="course-pills-tab-4">
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="https://eduport.webestica.com/assets/images/courses/4by3/01.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
				...
				<div class="tiny-slider-inner pb-1" data-autoplay="true" data-arrow="true" data-edge="2" data-dots="false" data-items="3" data-items-lg="2" data-items-sm="1">
					...
					<div>
						<div class="card action-trigger-hover border bg-transparent">
							<!-- Image -->
							<img src="https://eduport.webestica.com/assets/images/courses/4by3/14.jpg" class="card-img-top" alt="course image">
							<!-- Ribbon -->
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-1" src="https://eduport.webestica.com/assets/images/avatar/10.jpg" alt="avatar">
										</div>
					...
					<div>
						<div class="card action-trigger-hover border bg-transparent">
							<!-- Image -->
							<img src="https://eduport.webestica.com/assets/images/courses/4by3/15.jpg" class="card-img-top" alt="course image">
							<!-- Card body -->
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-3">
							...
							<div class="card-footer pt-0 bg-transparent">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-1" src="https://eduport.webestica.com/assets/images/avatar/04.jpg" alt="avatar">
										</div>
					...
					<div>
						<div class="card action-trigger-hover border bg-transparent">
							<!-- Image -->
							<img src="https://eduport.webestica.com/assets/images/courses/4by3/17.jpg" class="card-img-top" alt="course image">
							<!-- Card body -->
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-3">
							...
							<div class="card-footer pt-0 bg-transparent">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-1" src="https://eduport.webestica.com/assets/images/avatar/09.jpg" alt="avatar">
										</div>
					...
					<div>
						<div class="card action-trigger-hover border bg-transparent">
							<!-- Image -->
							<img src="https://eduport.webestica.com/assets/images/courses/4by3/16.jpg" class="card-img-top" alt="course image">
							<!-- Card body -->
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-3">
							...
							<div class="card-footer pt-0 bg-transparent">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-1" src="https://eduport.webestica.com/assets/images/avatar/01.jpg" alt="avatar">
										</div>
					...
					<div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
						<div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
							...
							<div class="d-flex align-items-center">
								<!-- Avatar -->
								<div class="avatar avatar-sm">
									<img class="avatar-img rounded-1" src="https://eduport.webestica.com/assets/images/avatar/02.jpg" alt="avatar">
								</div>
								<!-- Info -->
								<div class="ms-2">
